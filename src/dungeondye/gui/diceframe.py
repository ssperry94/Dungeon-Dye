...
"")
        ...
        self._dice_layout.addWidget(self._modifier_label, 5, 0)
        ...
        self._dice_layout.addWidget(self.roll_button, 5,0,1,2)
        ...
        self._dice_layout.addWidget(self._saved_rolls_label, 2, 1)
        ...
        self._dice_layout.addWidget(self._saved_roll_combo, 3, 1)
        ...
        self._dice_layout.addWidget(self._output_browser, 6,1,1,2)
